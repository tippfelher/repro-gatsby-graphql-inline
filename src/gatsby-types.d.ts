...
type Test2QueryVariables = Exact<{ [key: string]: never; }>;


type Test2Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly internal: { readonly contentFilePath: string | null } } }> } };
